...
- Значення годин модулів у формі є **тижневою квотою**. Довгий діапазон розбивається на календарні тижні, але всі тижні одного Generate/Fill job виконуються в одній `Serializable`-транзакції: помилка або скасування будь-якого тижня відкочує весь діапазон. Preflight послідовно симулює всі тижні в тій самій транзакції та наприкінці завжди відкочується.
