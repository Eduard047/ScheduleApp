...
Якщо таблиці `AutoGenJobRuns` немає, автогенерація все ще може працювати в пам'яті, але сервер не зможе надійно відновлювати статус job після перезапуску і в логах з'являться попередження про неможливість зберегти стан запуску.
